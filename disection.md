...
- `.forgejo/workflows/build.yml` and `ci/`: Forgejo CI for Linux amd64 or arm64 packaging plus native FreeBSD amd64 packaging and native FreeBSD aarch64 cross-packaging helpers, including filtered CI failure log shipping to the `CI.md` ingestion endpoint.
