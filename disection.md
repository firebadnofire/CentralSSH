...
- `.forgejo/workflows/build.yml` and `ci/`: Forgejo CI for Linux amd64 or arm64 packaging, native FreeBSD amd64 packaging, and FreeBSD aarch64 QEMU guest packaging and validation helpers, including filtered CI failure log shipping to the `CI.md` ingestion endpoint.
