...
- Linux and FreeBSD jobs run on their native runner classes, with package upload jobs waiting for the staged Forgejo release setup before they publish artifacts.
