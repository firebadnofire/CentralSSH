...
- If `settings.drop_to_menu=true`, an interactive shell channel is returned to the selection menu after the target shell exits; `Q` disconnects the SSH session from either selection menu.
