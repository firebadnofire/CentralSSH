...
Tagged runs create only a draft Forgejo release during packaging; the workflow publishes the real release only after every required Linux and FreeBSD pipeline finishes successfully.
