...
- Fallback host root when `/build-cache` is unavailable: `.ci-cache/`
- `CARGO_HOME`: `/build-cache/cargo-home`
- `SCCACHE_DIR`: `/build-cache/sccache/<repo>/<job>/<cache-key>`
- `CARGO_TARGET_DIR`: `/build-cache/target/<repo>/<job>/<cache-key>`
...
- Full Linux reset: remove `/build-cache/cargo-home`, `/build-cache/sccache`, and `/build-cache/target`
- Full FreeBSD reset: remove `/build-cache/freebsd`
